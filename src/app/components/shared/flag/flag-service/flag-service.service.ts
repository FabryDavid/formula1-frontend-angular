  ...
  async loadComponent(vcr: ViewContainerRef, country: string) {
    ...
    switch (country.toLowerCase()) {
      ...
      case "italy":
        ...
        break;
      case "japan":
        const {JapanFlagComponent} = await import("../flags/japan-flag/japan-flag.component")
      ...
      case "saudi arabia":
        ...
        break;
      case "singapore":
        const {SingaporeFlagComponent} = await import("../flags/singapore-flag/singapore-flag.component")
